...
export async function registerFulfillmentOfficers(request: Request, response: Response) {
...
export async function loginFulfillmentOfficers(request: Request, response: Response) {
...
export async function logoutFulfillmentOfficers(request: Request, response: Response) {
    try {
